      ...
      <header className="navbar">
        ...
        <div className="linkbutton">
          <ul className={clicked ? "nav-items" : "nav-items menu"}>
            <div className="hamburger" onClick={hamburgerMenu}>
              <button className="buttonhamburgerclose">
                {clicked ? <GrClose /> : ""}
              </button>
            </div>
            ...
            <li className="nav-item">
              <Link to="Macbook">
                <button className="button">Macbook </button>
              </Link>
            </li>
            <li className="nav-item">
              <Link to="Iphone">
                <button className="button">Iphone </button>
              </Link>
            </li>
            <li className="nav-item">
              <Link to="Ipad">
                <button className="button">Ipad </button>
              </Link>
            </li>
          </ul>
        </div>
